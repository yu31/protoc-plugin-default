...
func Test_TypeOptional1_Empty(t *testing.T) {
	...
	data := &pbtypes.TypeOptional1{
		FString1:    stringPointer(""),
		FString2:    stringPointer(""),
		FString3:    stringPointer(""),
		FString4:    stringPointer(""),
		FString5:    stringPointer(""),
		FString6:    stringPointer(""),
		FString7:    stringPointer(""),
		FString8:    stringPointer(""),
		FString9:    stringPointer(""),
		FInt32:      int32Pointer(0),
		FInt64:      int64Pointer(0),
		FUint32:     uint32Pointer(0),
		FUint64:     uint64Pointer(0),
		FSint32:     int32Pointer(0),
		FSint64:     int64Pointer(0),
		FSfixed32:   int32Pointer(0),
		FSfixed64:   int64Pointer(0),
		FFixed32:    uint32Pointer(0),
		FFixed64:    uint64Pointer(0),
		FFloat:      float32Pointer(0),
		FDouble:     float64Pointer(0),
		FBool1:      boolPointer(false),
		FBool2:      boolPointer(false),
		FBytes1:     []byte(""),
		FBytes2:     []byte(""),
		FEnum1:      &em1,
		FEnum2:      &em2,
...
func Test_TypeOptional1_Ignore(t *testing.T) {
	...
	data := &pbtypes.TypeOptional1{
		FString1:    stringPointer("101"),
		FString2:    stringPointer("102"),
		FString3:    stringPointer("103"),
		FString4:    stringPointer("104"),
		FString5:    stringPointer("105"),
		FString6:    stringPointer("106"),
		FString7:    stringPointer("107"),
		FString8:    stringPointer("108"),
		FString9:    stringPointer("109"),
		FInt32:      int32Pointer(101),
		FInt64:      int64Pointer(102),
		FUint32:     uint32Pointer(103),
		FUint64:     uint64Pointer(104),
		FSint32:     int32Pointer(105),
		FSint64:     int64Pointer(106),
		FSfixed32:   int32Pointer(107),
		FSfixed64:   int64Pointer(108),
		FFixed32:    uint32Pointer(109),
		FFixed64:    uint64Pointer(110),
		FFloat:      float32Pointer(111.111),
		FDouble:     float64Pointer(112.112),
		FBool1:      boolPointer(true),
		FBool2:      boolPointer(true),
		FBytes1:     []byte("bytes1"),
		FBytes2:     []byte("bytes2"),
		FEnum1:      &em1,
		FEnum2:      &em2,
