...
func (x *TypeOneOf1) SetDefault() {
	...
	case *TypeOneOf1_FAny1:
		if o.FAny1.GetTypeUrl() == "" {
			o.FAny1 = x.xxx_protoc_plugin_default_mustNewAny(&MessageOneOf1{}, false)
		}
	case *TypeOneOf1_FAny2:
		if o.FAny2.GetTypeUrl() == "" {
			o.FAny2 = x.xxx_protoc_plugin_default_mustNewAny(&MessageOneOf1{}, true)
		}
	case *TypeOneOf1_FAny3:
		if o.FAny3.GetTypeUrl() == "" {
			o.FAny3 = x.xxx_protoc_plugin_default_mustNewAny(&MessageOneOf1_Embed1{}, true)
		}
	case *TypeOneOf1_FAny4:
		if o.FAny4.GetTypeUrl() == "" {
			o.FAny4 = x.xxx_protoc_plugin_default_mustNewAny(&MessageOneOf1_Embed1_Embed2{}, false)
		}
	case *TypeOneOf1_FAny5:
		if o.FAny5.GetTypeUrl() == "" {
			o.FAny5 = x.xxx_protoc_plugin_default_mustNewAny(&pbexternal.External1{}, true)
		}
	case *TypeOneOf1_FAny6:
		if o.FAny6.GetTypeUrl() == "" {
			o.FAny6 = x.xxx_protoc_plugin_default_mustNewAny(&pbexternal.External2_Embed1{}, false)
		}
	case *TypeOneOf1_FAny7:
		if o.FAny7.GetTypeUrl() == "" {
			o.FAny7 = x.xxx_protoc_plugin_default_mustNewAny(&timestamppb.Timestamp{}, false)
		}
	case *TypeOneOf1_FAny8:
		if o.FAny8.GetTypeUrl() == "" {
			o.FAny8 = x.xxx_protoc_plugin_default_mustNewAny(&anypb.Any{}, false)
		}
	case *TypeOneOf1_FAny9:
		if o.FAny9.GetTypeUrl() == "" {
			o.FAny9 = x.xxx_protoc_plugin_default_mustNewAny(&MessageCommon1{}, false)
		}
	default:
...
func (*TypeOneOf1) xxx_protoc_plugin_default_mustNewAny(src proto.Message, skipEval bool) *anypb.Any {
	if !skipEval {
