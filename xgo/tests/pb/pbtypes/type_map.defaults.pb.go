...
func (x *TypeMap1) SetDefaults() {
	...
	if len(x.FAny1) == 0 {
		x.FAny1 = map[string]*anypb.Any{
			"a1": x.xxxPGD_mustNewAny(&MessageMap1{}, false),
			"a2": x.xxxPGD_mustNewAny(&MessageMap1_Embed1{}, false),
			"a3": x.xxxPGD_mustNewAny(&MessageMap1_Embed1_Embed2{}, false),
			"a4": x.xxxPGD_mustNewAny(&pbexternal.External1{}, false),
			"a5": x.xxxPGD_mustNewAny(&pbexternal.External2_Embed1{}, false),
			"a6": x.xxxPGD_mustNewAny(&timestamppb.Timestamp{}, false),
			"a7": x.xxxPGD_mustNewAny(&anypb.Any{}, false),
			"a8": x.xxxPGD_mustNewAny(&MessageCommon1{}, false),
			"":   nil,
		}
	}
}
...
func (*TypeMap1) xxxPGD_mustNewAny(src proto.Message, skipEval bool) *anypb.Any {
	if !skipEval {
...
// xxxPGD_mustNewAny used to create instance of type any
func (*TypeMap2) xxxPGD_mustNewAny(src proto.Message, skipEval bool) *anypb.Any {
	if !skipEval {
		if dt, ok := interface{}(src).(interface{ SetDefaults() }); ok {
			dt.SetDefaults()
		}
