...
type Plugin struct {
	flags    flag.FlagSet
	funcName string // The generated method func name for github.com/yu31/protoc-plugin-default/xgo.
...
func New() pkgenerator.Plugin {
	p := &Plugin{}
	// Usage: --godefault_opt="fn=SetDefault"
...
func (p *Plugin) getNameDefaultMethod() string {
	if p.funcName != "" {
		return p.funcName
	}
	return "SetDefault"
