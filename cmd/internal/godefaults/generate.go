...
import (
	...
	"github.com/yu31/protoc-plugin-defaults/cmd/internal/godefaults/pkg/importpkg"
)
...
func (p *Plugin) genCodeByFileType(field *protogen.Field, filedType *pbdefaults.FieldType,
...
func (p *Plugin) generateCodeForEval(field *protogen.Field, inOneOf bool) {
	...
	methodName := p.getNameDefaultsMethod()
